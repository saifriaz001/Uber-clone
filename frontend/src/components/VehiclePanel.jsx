...
const VehiclePanel = ({selectVehicle,setVehiclePanel ,setConfrimRidePanel , fare}) => {
  console.log("printing the fare ->", fare)
  return (
    <div>
       <div>
        <h5 onClick={()=>{
        ...
        }} className='p-3 text-center w-[93%]  absolute top-0  '><i className=" text-3xl text-gray-200 ri-arrow-down-wide-line"></i></h5>
        <h3 className='text-2xl font-semibold mb-5'>Choose a Vehicle</h3>
        <div onClick={()=>{
            setConfrimRidePanel(true)
            selectVehicle('car')
        }} className=' flex border-2  border-gray-200 active:border-black rounded-xl w-full p-3 items-center justify-between '>
        ...
        <div className=' w-1/2' >
          ...
          < p className='text-xs text-gray-600 font-normal'> Affordable motorcycle rides</p>
        </div>
